...
$classData = array (
  ...
  array (
    ...
    'description' => 'Bootstrap: everything big for calling extra attention to some special content',
  ),
  1 =>
  array (
    'classnames' => 'row',
    'description' => 'Bootstrap Grid: use with Wrapper Sections',
  ),
  2 =>
  array (
    'classnames' => 'col-xs-1 col-xs-2 col-xs-3 col-xs-4 col-xs-5 col-xs-6 col-xs-7 col-xs-8 col-xs-9 col-xs-10 col-xs-11 col-xs-12',
    'description' => 'Bootstrap Grid: column width on x-small screens (up to 767px)',
  ),
  3 =>
  array (
    'classnames' => 'col-sm-1 col-sm-2 col-sm-3 col-sm-4 col-sm-5 col-sm-6 col-sm-7 col-sm-8 col-sm-9 col-sm-10 col-sm-11 col-sm-12',
    'description' => 'Bootstrap Grid: column width on small screens (768–991px)',
  ),
  4 =>
  array (
    'classnames' => 'col-md-1 col-md-2 col-md-3 col-md-4 col-md-5 col-md-6 col-md-7 col-md-8 col-md-9 col-md-10 col-md-11 col-md-12',
    'description' => 'Bootstrap Grid: column width on medium screens (992–1199px)',
  ),
  5 =>
  array (
    'classnames' => 'col-lg-1 col-lg-2 col-lg-3 col-lg-4 col-lg-5 col-lg-6 col-lg-7 col-lg-8 col-lg-9 col-lg-10 col-lg-11 col-lg-12',
    'description' => 'Bootstrap Grid: column width on large screens (1200 and wider)',
  ),
  6 =>
  array (
    'classnames' => 'col-xs-push-1 col-xs-push-2 col-xs-push-3 col-xs-push-4 col-xs-push-5 col-xs-push-6 col-xs-push-7 col-xs-push-8 col-xs-push-9 col-xs-push-10 col-xs-push-11 col-xs-push-12',
    'description' => 'Bootstrap Grid: push colum to the right on on x-small screens (up to 767px)',
  ),
  7 =>
  array (
    'classnames' => 'col-sm-push-1 col-sm-push-2 col-sm-push-3 col-sm-push-4 col-sm-push-5 col-sm-push-6 col-sm-push-7 col-sm-push-8 col-sm-push-9 col-sm-push-10 col-sm-push-11 col-sm-push-12',
    'description' => 'Bootstrap Grid: push colum to the right on small screens (768–991px)',
  ),
  8 =>
  array (
    'classnames' => 'col-md-push-1 col-md-push-2 col-md-push-3 col-md-push-4 col-md-push-5 col-md-push-6 col-md-push-7 col-md-push-8 col-md-push-9 col-md-push-10 col-md-push-11 col-md-push-12',
    'description' => 'Bootstrap Grid: push colum to the right on medium screens (992–1199px)',
  ),
  9 =>
  array (
    'classnames' => 'col-lg-push-1 col-lg-push-2 col-lg-push-3 col-lg-push-4 col-lg-push-5 col-lg-push-6 col-lg-push-7 col-lg-push-8 col-lg-push-9 col-lg-push-10 col-lg-push-11 col-lg-push-12',
    'description' => 'Bootstrap Grid: push colum to the right on large screens (1200 and wider)',
  ),
  10 =>
  array (
    'classnames' => 'col-xs-pull-1 col-xs-pull-2 col-xs-pull-3 col-xs-pull-4 col-xs-pull-5 col-xs-pull-6 col-xs-pull-7 col-xs-pull-8 col-xs-pull-9 col-xs-pull-10 col-xs-pull-11 col-xs-pull-12',
    'description' => 'Bootstrap Grid: pull colum to the left on on x-small screens (up to 767px)',
  ),
  11 =>
  array (
    'classnames' => 'col-sm-pull-1 col-sm-pull-2 col-sm-pull-3 col-sm-pull-4 col-sm-pull-5 col-sm-pull-6 col-sm-pull-7 col-sm-pull-8 col-sm-pull-9 col-sm-pull-10 col-sm-pull-11 col-sm-pull-12',
    'description' => 'Bootstrap Grid: pull colum to the left on small screens (768–991px)',
  ),
  12 =>
  array (
    'classnames' => 'col-md-pull-1 col-md-pull-2 col-md-pull-3 col-md-pull-4 col-md-pull-5 col-md-pull-6 col-md-pull-7 col-md-pull-8 col-md-pull-9 col-md-pull-10 col-md-pull-11 col-md-pull-12',
    'description' => 'Bootstrap Grid: pull colum to the left on medium screens (992–1199px)',
  ),
  13 =>
  array (
    'classnames' => 'col-lg-pull-1 col-lg-pull-2 col-lg-pull-3 col-lg-pull-4 col-lg-pull-5 col-lg-pull-6 col-lg-pull-7 col-lg-pull-8 col-lg-pull-9 col-lg-pull-10 col-lg-pull-11 col-lg-pull-12',
    'description' => 'Bootstrap Grid: pull colum to the left on large screens (1200 and wider)',
  ),
  14 =>
  array (
    'classnames' => 'col-xs-offset-1 col-xs-offset-2 col-xs-offset-3 col-xs-offset-4 col-xs-offset-5 col-xs-offset-6 col-xs-offset-7 col-xs-offset-8 col-xs-offset-9 col-xs-offset-10 col-xs-offset-11 col-xs-offset-12',
    'description' => 'Bootstrap Grid: offset colum to the right on on x-small screens (up to 767px)',
  ),
  15 =>
  array (
    'classnames' => 'col-sm-offset-1 col-sm-offset-2 col-sm-offset-3 col-sm-offset-4 col-sm-offset-5 col-sm-offset-6 col-sm-offset-7 col-sm-offset-8 col-sm-offset-9 col-sm-offset-10 col-sm-offset-11 col-sm-offset-12',
    'description' => 'Bootstrap Grid: offset colum to the right on small screens (768–991px)',
  ),
  16 =>
  array (
    'classnames' => 'col-md-offset-1 col-md-offset-2 col-md-offset-3 col-md-offset-4 col-md-offset-5 col-md-offset-6 col-md-offset-7 col-md-offset-8 col-md-offset-9 col-md-offset-10 col-md-offset-11 col-md-offset-12',
    'description' => 'Bootstrap Grid: offset colum to the right on medium screens (992–1199px)',
  ),
  17 =>
  array (
    'classnames' => 'col-lg-offset-1 col-lg-offset-2 col-lg-offset-3 col-lg-offset-4 col-lg-offset-5 col-lg-offset-6 col-lg-offset-7 col-lg-offset-8 col-lg-offset-9 col-lg-offset-10 col-lg-offset-11 col-lg-offset-12',
    'description' => 'Bootstrap Grid: offset colum to the right on large screens (1200 and wider)',
  ),
);


		$avail_classes = array();
		foreach($classData as $class_info){

			$classes = preg_split('#\s+#',$class_info['classnames']);
			foreach($classes as $class){
				$avail_classes[] = array(
									'label'		=> $class.' '.$class_info['description'],
