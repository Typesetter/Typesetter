 ...
 * $source_file = 'path/to/input.jpg';
 * $destination_file = 'path/to/output.jpg';
 * 
 * function copy_profile($source_file, $destination_file){
 *   $o = new JPEG_ICC();
 *   $o->LoadFromJPEG($source_file);
 *   $o->SaveToJPEG($destination_file);
 * }
 * 
 * function remove_profile($source_file, $destination_file){
 *   $o = new JPEG_ICC();
 *   $o->RemoveFromJPEG($source_file, $destination_file, true);
 * }
 *
 */
